...
// import { InsightCard, TypingText, TitleText, NewFeatures } from '../components';
  ...
  >
    ...
    className="flex-[0.5] lg:max-w-[370px] flex justify-start flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a relative">
      ...
      <div>
        ...
        <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[45px] leading-[16px] text-white">
          Founder | Metaversus
        </p>
      </div>
